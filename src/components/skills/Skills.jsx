  ...
  return (
    <>
      <section>
        <div
          id="skills"
          className="xl:flex justify-center lg:gap-5 bg-gray-900 text-white pb-7 pt-5 md:pt-10 md:pb-[60px] px-3 text-[17px]"
        >
          <div className="flex justify-center xl:justify-start">
            <div>
              <h1 className="flex justify-center xl:justify-start font-bold">
                SKILLS
              </h1>
              ...
              <p className="min-w-0 max-w-[600px] leading-7 md:leading-8">
                ...
                porro a maxime tenetur? Ipsam nemo iusto minima dolorum animi
                nam sequi nesciunt.
              </p>
            </div>
          </div>
            ...
            <div className="lg:flex lg:gap-2">
              <div className="items-center border hover:border-blue-400 hover:text-blue-300 rounded-2xl p-3 min-w-0 max-w-[550px]">
                <legend className="text-[22px] font-bold">
                  <span className="text-white">Software</span> Development
